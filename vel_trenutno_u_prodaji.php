...
<head>
<meta charset="utf-8">
<title>Trenutno u prodaji</title>
...
<div id="artikli"></div>
	<div>
		<div class="container">
			<?php
				$sel_sql = "SELECT * FROM vel_trenutno_u_prodaji LIMIT $start_from,$per_page";
						...
						<div class="col-md-3" style="align-content: center;">
							<div class="panel panel-warning">
								...
								<div class="panel-body">
										<img class="modal-content" src="'.$rows['slika_vel_trenutno_u_prodaji'].'" style="width: 220px; height: 170px;" alt="Dječija spavaća soba" style="border: solid 1px black; margin-left: 20px; ">
										<div class="row">
